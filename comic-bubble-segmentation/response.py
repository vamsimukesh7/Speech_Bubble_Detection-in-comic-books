...
def image_upload():
    try:
        ...
        return {
            "message": "Extracted panels after user uploaded own image",
...
def user_sample_images():
    try:
        ...
        return {
            "message": "Extracted panels after user selected one from sample images",
            "inputImage": inputImage,
            "panels": panels,
        }, 200
    except:
...
def segment():
    try:
        ...
        return {
            "message": "Localized Bubbles and Extracted Text",
            "chosenPanel": var,
            "localized_bubbles": localized_bubbles,
            "extracted_string": extracted_text,
        }, 200
...
def test():
    try:
        ...
        for directory in os.listdir("./output"):
            temp = {"folderName": directory, "files": [], "folders": []}
            ...
            for folder in temp["folders"]:
                ...
                if "segmented_bubbles" in os.listdir(
